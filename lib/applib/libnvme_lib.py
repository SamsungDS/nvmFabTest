        ...
        while h:
            ...
            while s:
                ...
                while c:
                    ...
                    got_nqn = str(
                        self.libnvme.nvme_ctrl_get_subsysnqn(c))[2:-1]
                    if got_nqn == nqn:
                        ctrl.append(c)
                        # break
